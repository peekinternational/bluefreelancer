            ...
            <div class="col-md-3 mb-4">
                <div class="card card-bordered card-body rounded-xl mb-4">
                    ...
                    <ul class="nav flex-column">
                        <li class="nav-item">
                            <a href="/demos/bluefreelancer/public/support/show/General" class="nav-link">{{ __('general') }}</a>
                        </li>
                        <li class="nav-item">
                            <a href="/demos/bluefreelancer/public/support/show/Project" class="nav-link">{{ __('project') }}</a>
                        </li>
                        <li class="nav-item">
                            <a href="/demos/bluefreelancer/public/support/show/Contest" class="nav-link">{{ __('contest') }}</a>
                        </li>
                        <li class="nav-item">
                            <a href="/demos/bluefreelancer/public/support/show/Payment" class="nav-link">{{ __('paymentSetting') }}</a>
                        </li>
                        <li class="nav-item">
                            <a href="/demos/bluefreelancer/public/support/show/Membership" class="nav-link">{{ __('membership') }}</a>
                        </li>
                        <li class="nav-item">
                            <a href="/demos/bluefreelancer/public/support/show/Profile" class="nav-link">{{ __('profile') }}</a>
                        </li>
                    </ul>
                </div>
