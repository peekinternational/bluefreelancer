                    ...
                    <div class="card-header bg-secondary">
                        <div class="nav nav-pills nav-pills-light nav-fill flex-column flex-md-row mb-md-n2" id="nav-tab"
                            ...
                            <a class="nav-link py-2" id="nav-open-tab"
                                href="{{ route('my-project.employer.open-projects') }}">Open</a>
                            <a class="nav-link py-2 active" id="nav-work-tab" href="#nav-work">Work</a>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-nowrap py-3" style="min-width: 10rem;">
                                                    <select class="custom-select custom-select-sm"
                                                        ...
                                                        <option selected value="{{ route('my-project.employer.work-projects') }}">
                                                            Select</option>
                                                        <option value="{{ route('project.manage.milestone', $item->project_id) }}">
                                                            View Milestones
                                                        </option>
