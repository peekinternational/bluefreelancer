                ...
                <div class="card rounded-xl overflow-hidden">
                    <div class="card-header bg-secondary">
                        <div class="nav nav-pills nav-pills-light nav-fill flex-column flex-md-row mb-md-n2" id="nav-tab"
                            role="tablist">
                            <a class="nav-link py-2 active" id="nav-open-tab" href="#nav-open">Open</a>
                            <a class="nav-link py-2" id="nav-work-tab"
                                href="{{ route('my-project.employer.work-projects') }}">Work</a>
                            <a class="nav-link py-2" id="nav-past-project-tab"
                                href="{{ route('my-project.employer.past-projects') }}">Past Project</a>
                            <a class="nav-link py-2" id="nav-active-contest-tab"
                                href="{{ route('my-project.employer.open-contests') }}">Open Contest</a>
                            <a class="nav-link py-2" id="nav-past-contest-tab"
                                href="{{ route('my-project.employer.awarded-contests') }}">Awarded Contest</a>
                        </div>
                    </div>
                </div>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-nowrap py-3" style="min-width: 10rem;">
                                                    <select class="custom-select custom-select-sm"
                                                        ...
                                                        <option selected value="{{ route('my-project.employer.open-projects') }}">
                                                            Select</option>
                                                        <option value="{{ route('project.manage.proposals', $item->project_id) }}">
                                                            View Applicant
                                                        </option>
                                                        <option value="{{ route('project.manage.modify', $item->project_id) }}">
                                                            Modify Project
                                                        </option>
                                                    </select>
                                                </td>
