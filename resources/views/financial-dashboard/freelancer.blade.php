...
<section class="container py-5 my-3 my-md-4">
    <h2 class="h4 font-weight-bold mb-3">Freelancer Financial Dasboard</h2>
    ...
    <div class="card overflow-hidden mb-5">
        <div class="card-header border-0 d-flex justify-content-between">
            ...
            <div class="d-flex">
                <a class="mx-2 p-2" href="{{ route('financial-dashboard.employer') }}">Employer</a>
                <a class="mx-2 bg-success text-white p-2 rounded" href="{{ route('financial-dashboard.freelancer') }}">Freelancer</a>
            </div>
        </div>
    </div>
    <table class="table font-size-sm">
        <thead class="bg-white">
            <tr>
                ...
                <th class="text-nowrap" scope="col">Client/Employer</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-nowrap">{{ App\Models\User::where('id', $item->from)->first()->username }}</td>
