...
<section class="container py-5 my-3 my-md-4">
    <div class="d-flex justify-content-between my-2">
        <h2 class="h4 font-weight-bold mb-3">Deposit History</h2>
        <a href="{{route('transaction-history.withdraw')}}" class="btn btn-info">Withdraw History</a>
    </div>
                ...
                <table class="table table-striped font-size-sm">
                    <thead class="bg-white">
                        <tr>
                            ...
                            <th class="text-nowrap" scope="col">Gross Amount</th>
                            <th class="text-nowrap" scope="col">Paypal Fee</th>
                            <th class="text-nowrap" scope="col">Net Amount</th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-danger">{{$item->fee_amt}}</td>
                            <td class="text-success">{{$item->net_amt}}</td>
                        </tr>
                        @endforeach
                        @else
                        {{__('notFound')}}
